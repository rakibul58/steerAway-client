...
export default function BestValue() {
  const {
    ...
    { name: "limit", value: "4" },
    { name: "sort", value: "pricing.basePrice" },
  ]);
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="mb-12">
          <h2 className="text-4xl font-bold">Best Value Vehicles</h2>
          <p className="text-lg text-foreground mt-4">
            Affordable options that deliver exceptional quality and performance.
          </p>
        </div>
          ...
          {isFetching || isLoading ? (
            ...
            <div>
              ...
              <div className="text-center mt-12">
                <Link to={"car-listings?sort=pricing.basePrice"}>
