export const SellingPoints = [
  ...
  },
  {
    ...
    description:
      "We are trusted by thousands of customers for our reliable and quality service.",
  },
  {
    id: 5,
    icon: (
    ...
    description:
      "Drive with peace of mind knowing all our rentals include comprehensive insurance coverage.",
  },
  {
    id: 6,
    icon: (
    ...
    description:
      "Experience our top-rated service that prioritizes your comfort and satisfaction.",
  },
];
